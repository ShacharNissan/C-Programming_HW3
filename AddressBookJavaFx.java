...
class primAddressBookPane implements myDecorator {
	...
	public void setOrigin() {
		origin.setState(abp.GetName(), abp.GetStreet(), abp.GetCity(), abp.GetState(), abp.GetZip());
		origin.saveStateToMemento();
...
class CommandButton extends Button implements Command {
	...
	public void writeAddress() {
		...
		try {
			...
			// originator.setState(p.GetName(), p.GetStreet(), p.GetCity(), p.GetState(),
			// p.GetZip());
			// caretaker.add(originator.saveStateToMemento());
			//
			// System.out.println(originator.getName() + originator.getStreet() +
			// originator.getZip());
